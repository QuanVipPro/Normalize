...
public class TextView {
    ...
    public FileWorking fileW = new FileWorking();
    ...
    public void input(TextModel txtModel) {
        try {
    ...
    public void nomalize(TextModel txtModel) {
    ...
    public void output(TextModel txtModel) {
        try {
